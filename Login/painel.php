...
<html>
    ...
    <body>
                ...
                <div class="col-xs-12">
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <!-- Em caso de uso em um navegador mobile-->  
                            ...
                            <!-- outra sessao para coletar os dados-->
        ...
        <div class="max-width" id="dvConteudo"> <!--Div especifica que mostrara o conteudo das paginas-->
            <div class="row">
